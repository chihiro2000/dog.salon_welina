...
export function AccessMap() {
  return (
    <section className="bg-[#fcf9e4] py-8 sm:py-24">
      <div className="container">
        ...
        <div className="mx-auto grid max-w-5xl gap-4 sm:gap-8 md:grid-cols-2">
          <div>
            <div className="mb-4 sm:mb-8 space-y-4 sm:space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="mb-1 sm:mb-2 text-xl font-semibold text-[#4a4333]">
                    所在地
                  </h3>
          ...
          <div className="h-[250px] sm:h-[300px] overflow-hidden rounded-lg border border-[#e6deb7] shadow-sm md:h-[350px]">
            <iframe
